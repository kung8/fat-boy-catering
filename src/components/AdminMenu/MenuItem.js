...
export default function MenuItem(props) {
    const { item, catIndex, catCollapsed, menuItemToggleFromAdmin, screenSize, mini, updateMenuItemModal } = props;
    ...
    const handleItemCollapse = (bool) => {
        ...
        let saveOrX = document.getElementById('x-item-' + id) || document.getElementById('save-item-' + id);
