...
export default function Category(props) {
    const { category, index, screenSize, mini, menuItemToggleFromAdmin, isLast, removeCategoryGroup } = props;
    ...
    const saveCategory = async (bool) => {
        ...
        if (check) {
            ...
            // showToast('Please fill out all the fields', 'salmon');
        }
    }
