                        ...
                        return (
                            <div key={categoryId} className={`category-card ${collapsed && 'collapsed-card'}`}>
                                ...
                                <div className={`category-img-and-menu col wrap ${collapsed && 'none'}`} style={{ height: !collapsed && height }}>
                                    <img id={`category-img-${index}`} className="category-highlighted-img" src={image.includes('.jpg') || image.includes('.png') ? image : googleDriveURL + image} alt="category highlights" />
                                    {menuItems.map(item => {
    ...
    return (
        <Loading loaded={isLoaded} checkHeight={checkHeight} image='.hero'>
            <div className="menu-page col align-ctr">
                <img src={hero.includes('.jpg') || hero.includes('.png') ? hero : googleDriveURL + hero} alt="hero" className="hero" />
                {mapMenu()}
