...
export default function AdminMenu(props) {
    ...
    const handleCollapse = async (index, bool, categoryId) => {
        ...
        if (bool) {
            ...
            document.querySelectorAll('.save-item-cat-' + index).forEach(save => save.classList.add('none'));
        }
